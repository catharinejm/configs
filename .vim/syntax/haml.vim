...
unlet! b:current_syntax
silent! syn include @hamlCoffeescriptTop syntax/coffee.vim
unlet! b:current_syntax
...
syn region  hamlCoffeescriptFilter matchgroup=hamlFilter start="^\z(\s*\):coffee\(script\)\?\s*$" end="^\%(\z1 \| *$\)\@!" contains=@hamlCoffeescriptTop,hamlInterpolation keepend
